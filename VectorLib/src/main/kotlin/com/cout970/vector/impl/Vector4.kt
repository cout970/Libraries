...
//@formatter:off
data class MutableVector4i(var xi: Int, var yi: Int, var zi: Int, var wi: Int) : IMutableVector4 {
...
data class MutableVector4f(var xf: Float, var yf: Float, var zf: Float, var wf: Float) : IMutableVector4 {
...
data class MutableVector4d(var xd: Double, var yd: Double, var zd: Double, var wd: Double) : IMutableVector4 {
