...
operator fun IVector4.plus(other: Number) = vec4Of(xd + other.toDouble(), yd + other.toDouble(), zd + other.toDouble(), wd + other.toDouble())
...
operator fun IVector4.minus(other: Number) = vec4Of(xd - other.toDouble(), yd - other.toDouble(), zd - other.toDouble(), wd - other.toDouble())
...
operator fun IVector4.div(other: Number) = vec4Of(xd / other.toDouble(), yd / other.toDouble(), zd / other.toDouble(), wd / other.toDouble())