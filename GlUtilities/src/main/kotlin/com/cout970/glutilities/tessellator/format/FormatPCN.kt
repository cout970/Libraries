 ...
 * Position (3 elements), Color (3 elements), Normal (3 elements)
 */
class FormatPCN : IFormat {
    ...
    override fun getBuffers(): List<IBuffer> = listOf(bufferPos, bufferCol, bufferNorm)
